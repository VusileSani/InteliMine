...
export const EMPLOYEES = Object.freeze([
  {
    ...
    departmentId: "DEPT-ENG", areaId: "AREA-SEC3", operationId: "OP-DEMO",
    supervisorEmployeeNo: "107199", employmentStatus: "ACTIVE", shiftGroup: "B", workLocation: "Underground",
    badgeId: "CARD-104782", mobileNumber: "", email: "", sourceSystem: "DEMO", sourceRecordId: "104782",
  ...
  },
  {
    ...
    departmentId: "DEPT-ENG", areaId: "AREA-SEC3", operationId: "OP-DEMO",
    supervisorEmployeeNo: "107199", employmentStatus: "ACTIVE", shiftGroup: "B", workLocation: "Underground",
    badgeId: "CARD-105310", mobileNumber: "", email: "", sourceSystem: "DEMO", sourceRecordId: "105310",
    effectiveFrom: "2026-01-01", effectiveTo: "", lastUpdatedAt: "2026-09-05T18:00:00+02:00"
  },
  {
    ...
    departmentId: "DEPT-SAF", areaId: "AREA-SEC3", operationId: "OP-DEMO",
    supervisorEmployeeNo: "107199", employmentStatus: "ACTIVE", shiftGroup: "B", workLocation: "Underground",
    badgeId: "CARD-106004", mobileNumber: "", email: "", sourceSystem: "DEMO", sourceRecordId: "106004",
    effectiveFrom: "2026-01-01", effectiveTo: "", lastUpdatedAt: "2026-09-05T18:00:00+02:00"
  },
  {
    ...
    departmentId: "DEPT-PROD", areaId: "AREA-SEC3", operationId: "OP-DEMO",
    supervisorEmployeeNo: "", employmentStatus: "ACTIVE", shiftGroup: "B", workLocation: "Underground",
    badgeId: "CARD-107199", mobileNumber: "", email: "", sourceSystem: "DEMO", sourceRecordId: "107199",
    effectiveFrom: "2026-01-01", effectiveTo: "", lastUpdatedAt: "2026-09-05T18:00:00+02:00"
  },
  {
    ...
    departmentId: "DEPT-PROD", areaId: "AREA-PANEL-B", operationId: "OP-DEMO",
    supervisorEmployeeNo: "107199", employmentStatus: "ACTIVE", shiftGroup: "B", workLocation: "Underground",
    badgeId: "CARD-108022", mobileNumber: "", email: "", sourceSystem: "DEMO", sourceRecordId: "108022",
    effectiveFrom: "2026-01-01", effectiveTo: "", lastUpdatedAt: "2026-09-05T18:00:00+02:00"
  }
]);
...
function provenance(channel = "KIOSK", capturePointId = "KIOSK-DEMO-01") {
  return {
    captureChannel: channel,
    capturePointId,
    sourceSystem: "INTELIMINE_DEMO",
    sourceRecordId: null,
    importBatchId: null
  };
}
...
export const DEMO_ATTENDANCE = Object.freeze([
  { attendanceId: "ATT-104782", employeeId: "emp_104782", shiftInstanceId: APP_CONFIG.shiftInstanceId, clockedIn: true, clockInAt: "2026-09-05T18:01:00+02:00", sourceSystem: "T_AND_A_DEMO" },
  { attendanceId: "ATT-105310", employeeId: "emp_105310", shiftInstanceId: APP_CONFIG.shiftInstanceId, clockedIn: true, clockInAt: "2026-09-05T17:58:00+02:00", sourceSystem: "T_AND_A_DEMO" },
  { attendanceId: "ATT-106004", employeeId: "emp_106004", shiftInstanceId: APP_CONFIG.shiftInstanceId, clockedIn: true, clockInAt: "2026-09-05T18:03:00+02:00", sourceSystem: "T_AND_A_DEMO" },
  { attendanceId: "ATT-107199", employeeId: "emp_107199", shiftInstanceId: APP_CONFIG.shiftInstanceId, clockedIn: true, clockInAt: "2026-09-05T17:49:00+02:00", sourceSystem: "T_AND_A_DEMO" },
  { attendanceId: "ATT-108022", employeeId: "emp_108022", shiftInstanceId: APP_CONFIG.shiftInstanceId, clockedIn: true, clockInAt: "2026-09-05T18:05:00+02:00", sourceSystem: "T_AND_A_DEMO" }
]);

export const DEMO_REPORTING_OBLIGATIONS = Object.freeze(DEMO_ATTENDANCE.map(entry => ({
...
export const DEMO_INITIAL_CHECK_FACTS = Object.freeze([
...
export const DEMO_INITIAL_OBSERVATIONS = Object.freeze([
  {
...
export const DEMO_INITIAL_ISSUES = Object.freeze([
  {
    issueId: "ISS-20260905-0001", title: "CV-04 abnormal vibration", operationId: "OP-DEMO", areaId: "AREA-CONVEYOR", equipmentId: "EQ-CV04",
    eventTypeId: "EVT-VIBRATION", severityId: "MEDIUM", currentStatus: "OPEN", openedAt: "2026-09-05T18:47:00+02:00",
  ...
  {
    issueId: "ISS-20260905-0002", title: "Panel B loose rock hazard", operationId: "OP-DEMO", areaId: "AREA-PANEL-B", equipmentId: null,
    eventTypeId: "EVT-HAZARD", severityId: "HIGH", currentStatus: "ACKNOWLEDGED", openedAt: "2026-09-05T18:42:00+02:00",
...
export const DEMO_INTEGRATION_BATCHES = Object.freeze([
  {
    batchId: "IMP-EMP-20260905-001", entityType: "EMPLOYEE_MASTER", sourceSystem: "DEMO_HR", receivedAt: "2026-09-05T15:00:00+02:00",
  ...
  {
    batchId: "IMP-EQP-20260905-001", entityType: "EQUIPMENT_MASTER", sourceSystem: "DEMO_ASSET", receivedAt: "2026-09-05T15:10:00+02:00",
